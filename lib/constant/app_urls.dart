...
//  static const String BASE_URL='http://192.168.190.98:8082/wx'; //测试服务.
  ...
  static const String HOME_FIRST_CATEGORY=BASE_URL + '/goods/classify/list'; //商品分类第一级
  static const String HOME_SECOND_CATEGORY=BASE_URL + '/goods/classify/list'; //商品分类第二级
  ...
  static const String LOGIN = BASE_URL + '/account/login'; //登录
  static const String ADD_CART = BASE_URL + '/goods/cart/add'; //加入购物车
  static const String FAST_BUY = BASE_URL + '/goods/cart/fastadd'; //立即购买
  static const String COLLECT_ADD_DELETE = BASE_URL + '/common/collection/add'; //添加或取消收藏
  static const String CART_LIST = BASE_URL + '/goods/cart/list'; //购物车数据
  static const String CART_UPDATE = BASE_URL + '/goods/cart/update'; //更新购物车
  static const String CART_DELETE = BASE_URL + '/goods/cart/delete'; //删除购物车数据
  static const String CART_CHECK = BASE_URL + '/goods/cart/checked'; //购物车商品勾选
  static const String CART_BUY = BASE_URL + '/goods/cart/checkout'; //购物车下单
  ...
  static const String MINE_FOOTPRINT = BASE_URL + '/goods/browse/history'; //足迹
  static const String MINE_FOOTPRINT_DELETE = BASE_URL + '/footprint/delete'; //删除足迹
  static const String MINE_COLLECT = BASE_URL + '/common/collection/list'; //收藏列表
